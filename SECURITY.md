...
- Bootstrap `admin` / `admin` credentials must be changed before a remote demo
- Admin/ordinary-user authorization is application-level; it is not runtime tenant isolation
- No CSRF protection
