...
# Keep false for this HTTP proof-of-concept deployment. Set true after putting
# Launchpad behind HTTPS.
...
- Add HTTPS before using `APP_AUTH_TOKEN` across an untrusted network, then set
